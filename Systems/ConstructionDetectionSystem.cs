...
namespace ConstructionAnimation.Systems
{
    public partial class ConstructionDetectionSystem : GameSystemBase
    {
        ...
        private sealed class ConstructionVisual
        {
            ...
            public GameObject ConcreteFoundationRoot;
        ...
        private GameObject CreateConcreteFoundationVisual(
            GameObject parent,
            ConstructionVisual visual
        )
        {
            ...
            const float foundationThickness =
                1.50f;

            const float foundationTopAboveBase =
                1.00f;

            float centerY =
                visual.StructureGeometryBaseY +
                foundationTopAboveBase -
                foundationThickness *
                0.5f;
            ...
            GameObject foundation =
                CreateConcreteSlab(
                    ...
                    centerY,
                    foundationThickness,
                    "ConstructionAnimation_ConcreteFoundation_" +
                    visual.Source.Index +
                    "_" +
                    visual.Source.Version
                );
        ...
        private GameObject CreateConcreteSlab(
            GameObject parent,
            List<Vector2> polygon,
            float centerY,
            float thickness,
        ...
        )
        {
            ...
            slab.transform.SetParent(
                parent.transform,
                false
            );

            MeshFilter filter =
                slab.AddComponent<MeshFilter>();
        ...
        )
        {
            ...
            visual.ConcreteFoundationRoot =
                CreateConcreteFoundationVisual(
                    root,
                    visual
                );
